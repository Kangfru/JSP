...
<body>
	...
	<form name=writeForm method="post" action="writePro.jsp" onSubmit="return writeSave()">
		...
		<table width="500" cellpadding="3" bgColor="<%=bodyback_c %>" align="center">
			<tr>
				<td colspan="2" align="right" bgColr="<%=value_c%>">
			...
			<tr bgColor="<%=value_c%>">
				<td>이메일</td>
				<td><input type="text" name="email" id="email" size="30" placeholder="example@instance.com"/></td>
			...
			<tr bgColor="<%=value_c%>">
				<td>비밀번호</td>
				<td><input type="password" name="passwd" id="passwd" size="12"/></td>
			</tr>
